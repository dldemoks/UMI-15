...
mysql_query("INSERT INTO `cms3_object_fields` VALUES(NULL, 'payeer_url', 'URL мерчанта (по умолчанию, https://payeer.com/merchant/)', 0, 16, 0, 1, NULL, 0, 0, 'url для оплаты в системе Payeer', 1, NULL, 0, 0, 0)");
mysql_query("SET @field = LAST_INSERT_ID()");
mysql_query("INSERT INTO `cms3_fields_controller` VALUES (15, @field, @field_group)");

mysql_query("INSERT INTO `cms3_object_fields` VALUES(NULL, 'payeer_shop', 'Идентификатор магазина', 0, 16, 0, 1, NULL, 0, 0, 'Идентификатор магазина, зарегистрированного в Payeer', 1, NULL, 0, 0, 0)");
mysql_query("SET @field = LAST_INSERT_ID()");
mysql_query("INSERT INTO `cms3_fields_controller` VALUES (20, @field, @field_group)");

mysql_query("INSERT INTO `cms3_object_fields` VALUES(NULL, 'payeer_key', 'Секретный ключ', 0, 16, 0, 1, NULL, 0, 0, 'Секретный ключ магазина', 1, NULL, 0, 0, 0)");
mysql_query("SET @field = LAST_INSERT_ID()");
mysql_query("INSERT INTO `cms3_fields_controller` VALUES (25, @field, @field_group)");

mysql_query("INSERT INTO `cms3_object_fields` VALUES(NULL, 'payeer_log', 'Путь до журнала платежных операций (например, /payeer_orders.log)', 0, 16, 0, 1, NULL, 0, 0, 'Если путь не указан, то журнал не записывается', 0, NULL, 0, 0, 0)");
mysql_query("SET @field = LAST_INSERT_ID()");
mysql_query("INSERT INTO `cms3_fields_controller` VALUES (30, @field, @field_group)");

mysql_query("INSERT INTO `cms3_object_fields` VALUES(NULL, 'payeer_ipfilter', 'IP фильтр', 0, 16, 0, 1, NULL, 0, 0, 'Список доверенных ip адресов, можно указать маску', 0, NULL, 0, 0, 0)");
mysql_query("SET @field = LAST_INSERT_ID()");
mysql_query("INSERT INTO `cms3_fields_controller` VALUES (35, @field, @field_group)");

mysql_query("INSERT INTO `cms3_object_fields` VALUES(NULL, 'payeer_emailerr', 'Email для ошибок', 0, 16, 0, 1, NULL, 0, 0, 'Электронная почта для отчетов об ошибках оплаты', 0, NULL, 0, 0, 0)");
mysql_query("SET @field = LAST_INSERT_ID()");
